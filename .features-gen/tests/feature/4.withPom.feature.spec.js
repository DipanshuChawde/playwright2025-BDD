...
test.describe('Verify login pahe of Demoblaze with pom', () => {
  ...
  test('verify login page of demoblaze2', async ({ Given, page, When, And, Then }) => { 
    ...
    await When('I click on login Log-in button2'); 
